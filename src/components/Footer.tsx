...
export default function Footer() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const waText = `*New Dispatch Inquiry*\n\n*Name:* ${name || 'N/A'}\n*Email:* ${email}\n*Plan:* ${planType}\n\n*Message:*\n${message}`;
    const encodedText = encodeURIComponent(waText);
    window.open(`https://wa.me/918921546426?text=${encodedText}`, '_blank');
          ...
          <div className="lg:col-span-7 bg-white/[0.01] border border-white/10 rounded-3xl p-8 backdrop-blur-sm shadow-[0_4px_30px_rgba(0,0,0,0.4)] flex flex-col justify-between" id="contact_form_area">
            ...
            <div className="mb-6">
              ...
              <p className="font-sans text-xs text-gray-400 text-left">
                Directly communicate your project specs to Devaan. We reply under 12 hours.
              </p>
            </div>
                ...
                {isSubmitted && (
                  ...
                  >
                    ...
                    <span className="text-[11px] leading-relaxed opacity-80">
                      Thank you! We will reach out to you via <strong>support@dotdvn.me</strong>.
                    </span>
                  </motion.div>
                )}
              </AnimatePresence>
